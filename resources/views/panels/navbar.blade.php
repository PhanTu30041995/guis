        ...
        <div class="navbar-collapse" id="navbar-mobile">
          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
                ...
                <span><img class="round" src="{{ asset("") }}uploads/avatars/{{ Auth::user()->avatar }}" alt="avatar" height="40"
                    width="40" /></span>
              </a>
              <div class="dropdown-menu dropdown-menu-right">
                @role('admin')
                <a class="dropdown-item" href="{{ route('app-user-list') }}"><i class="feather icon-user"></i> User Management</a>
                @endrole
